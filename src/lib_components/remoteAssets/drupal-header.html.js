...
export default html = `<header class="header" role="banner">
  ...
  <a href="/" title="Home" rel="home" id="block-neon-site-branding" class="logo">
    ...
    <label for="nav-trigger">
      ...
      <svg class="nav-trigger__icon nav-trigger__icon--expand" xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 20 18"><path d="M0 0h20v2H0V0zm0 16h20v2H0v-2zm0-8h20v2H0V8z"></path></svg>

      <svg class="nav-trigger__icon nav-trigger__icon--collapse" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path d="M1.636.222l14.142 14.142-1.414 1.414L.222 1.636 1.636.222zM.222 14.364L14.364.222l1.414 1.414L1.636 15.778.222 14.364z"></path></svg>
...
</div><input autocomplete="off" data-drupal-selector="form-yi3eylrr3lzk4uf1-nu6xmwlghw2rve9bevbv1ripwm" type="hidden" name="form_build_id" value="form-Yi3EyLRR3Lzk4uf1-Nu6XMwLGhW2rVE9Bevbv1RiPwM">
<input data-drupal-selector="edit-openid-connect-login-form" type="hidden" name="form_id" value="openid_connect_login_form">
  ...
  <h2 class="visually-hidden" id="block-neon-main-menu-menu">Main navigation</h2>
          ...
          <a href="https://www.neonscience.org/about" class="menu__link" title="About Us" data-plugin-id="menu-link-contentcf5cd374-1932-49b4-84fb-c84373c74a2e" data-drupal-link-system-path="node/8793">About Us</a>
                                        ...
                                        <button class="arrow visually-hidden focusable" tabindex="0" aria-label="Toggle Mega Menu"><svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9 1L5 5 1 1" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></button>
          ...
          <a href="https://www.neonscience.org/neon-code-conduct" class="menu__link" data-plugin-id="menu-link-contentbc4a11ea-ed09-4faf-97e2-3d90fb4400ba" data-drupal-link-system-path="node/12759">Code of Conduct</a>
              ...
              <div class="subNavLabelWrapper">
                <button class="subNavClose isDesktop" aria-label="Close Mega Menu">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.808 17.778L17.778.808l1.414 1.414-16.97 16.97-1.414-1.414z" fill="#fff"></path><path d="M2.222.808l16.97 16.97-1.414 1.414L.808 2.222 2.222.808z" fill="#fff"></path></svg>
                </button>
                <h3 class="isDesktop">About Us</h3>
                <button class="mobileBack isMobile" aria-label="Back">
                  <svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5 9L1 5l4-4M1 5h12" stroke="#0073CF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                  </svg>
                </button>
              </div>
                            </div>
...
<div class="search-form-mobile isMobile" id="block-searchform-mobile" role="search">
...
<input data-drupal-selector="edit-submit" type="submit" id="edit-submit" value="Search" class="button js-form-submit form-submit button--search">
        ...
        <div class="header__search-close">
          <button aria-label="Close Search" class="button__search-close">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.808 17.778L17.778.808l1.414 1.414-16.97 16.97-1.414-1.414z" fill="#0073CF"></path><path d="M2.222.808l16.97 16.97-1.414 1.414L.808 2.222 2.222.808z" fill="#0073CF"></path></svg>
          </button>
